...
public class PressureRecipe implements Recipe<SimpleInventory> {
    public enum Weather {
        CLEAR,
        RAIN,
        THUNDERING;
    ...
    public PressureRecipe(Identifier id, ItemStack output,
    ...
    public static class Type implements RecipeType<PressureRecipe> {
        private Type() { }
    ...
    public static class Serializer implements RecipeSerializer<PressureRecipe> {
        ...
        @Override
        public PressureRecipe read(Identifier id, JsonObject json) {
            ...
            return new PressureRecipe(id, output,
                    inputs, Weather.getWeatherByString(weather));
        }

        @Override
        public PressureRecipe read(Identifier id, PacketByteBuf buf) {
        ...
        @Override
        public void write(PacketByteBuf buf, PressureRecipe recipe) {
