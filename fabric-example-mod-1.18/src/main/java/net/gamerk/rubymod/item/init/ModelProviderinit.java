...
public class ModelProviderinit {
    public static void init() {
        ...
        FabricModelPredicateProviderRegistry.register(ModItems2.COBALT_BOW, new Identifier("pull"), (stack, world, entity, seed) -> {
            if (entity == null) {
                return 0.0F;
            }
            return entity.getActiveItem() != stack ? 0.0F : (stack.getMaxUseTime() - entity.getItemUseTimeLeft()) / 20.0F;
        ...
        FabricModelPredicateProviderRegistry.register(ModItems2.COBALT_BOW, new Identifier("pulling"), (stack, world, entity, seed) -> {
            if (entity == null) {
                return 0.0F;
            }
            return entity.isUsingItem() && entity.getActiveItem() == stack ? 1.0F : 0.0F;
