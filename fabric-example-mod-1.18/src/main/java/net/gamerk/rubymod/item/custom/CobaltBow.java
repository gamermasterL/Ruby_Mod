...
public class CobaltBow extends BowItem {
    public static final int field_30855 = 38;
    public static final int RANGE = 33;

    public CobaltBow(Settings settings) {
        super(settings);
    }
    ...
    public void onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        ...
        if (!world.isClient) {
            ...
            persistentProjectileEntity.setVelocity(playerEntity, playerEntity.getPitch(), playerEntity.getYaw(), 0.0f, f * 3.5f, 1.0f);
            if (f == 1.0f) {
