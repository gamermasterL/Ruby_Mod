...
public class PressureScreenHandler extends ScreenHandler {
    ...
    public PressureScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate delegate) {
        super(ModScreenHandler.PRESSURE_SCREEN_HANDLER, syncId);
